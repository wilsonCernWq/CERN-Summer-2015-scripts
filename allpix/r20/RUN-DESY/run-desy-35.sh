...
# run simulation
allpix /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-20/RUN-DESY/run-desy-35.in q

# compress data
cd ./EUTelescopeFiles/run-desy-35
find . -name '*.txt' -print | tar -cvzf run-desy-35.tar.gz --files-from -
mv run-desy-35.tar.gz /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-20/RUN-DESY
