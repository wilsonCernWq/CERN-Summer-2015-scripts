...
# run simulation
allpix /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-20/RUN-DESY/run-desy-38.in q

# compress data
cd ./EUTelescopeFiles/run-desy-38
find . -name '*.txt' -print | tar -cvzf run-desy-38.tar.gz --files-from -
mv run-desy-38.tar.gz /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-20/RUN-DESY
