...
# run simulation
allpix /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-50/RUN-DESY/run-desy-10.in q

# compress data
cd ./EUTelescopeFiles/run-desy-10
find . -name '*.txt' -print | tar -cvzf run-desy-10.tar.gz --files-from -
mv run-desy-10.tar.gz /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-50/RUN-DESY
