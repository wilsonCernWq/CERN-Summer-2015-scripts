...
# run simulation
allpix /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-50/RUN-DESY/run-desy-14.in q

# compress data
cd ./EUTelescopeFiles/run-desy-14
find . -name '*.txt' -print | tar -cvzf run-desy-14.tar.gz --files-from -
mv run-desy-14.tar.gz /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-50/RUN-DESY
