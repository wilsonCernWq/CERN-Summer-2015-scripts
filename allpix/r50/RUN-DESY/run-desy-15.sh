...
# run simulation
allpix /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-50/RUN-DESY/run-desy-15.in q

# compress data
cd ./EUTelescopeFiles/run-desy-15
find . -name '*.txt' -print | tar -cvzf run-desy-15.tar.gz --files-from -
mv run-desy-15.tar.gz /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-50/RUN-DESY
