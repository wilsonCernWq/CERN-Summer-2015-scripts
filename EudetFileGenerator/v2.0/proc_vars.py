...
def substitute(ifile, ofile):
    ...
    line += indentation + 'NODE_NUM = node_num()\n'
    line += indentation + 'update_var()\n'
    line += indentation + 'o = open(ofile + "-" + str(NODE_NUM) + ".in", "w")\n'
...
if __name__ == "__main__":
    ...
    substitute(sys.argv[1], sys.argv[3])
