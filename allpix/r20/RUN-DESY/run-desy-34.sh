...
# run simulation
allpix /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-20/RUN-DESY/run-desy-34.in q

# compress data
cd ./EUTelescopeFiles/run-desy-34
find . -name '*.txt' -print | tar -cvzf run-desy-34.tar.gz --files-from -
mv run-desy-34.tar.gz /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-20/RUN-DESY
