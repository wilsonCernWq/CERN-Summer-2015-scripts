...
# run simulation
allpix /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-20/RUN-DESY/run-desy-11.in q

# compress data
cd ./EUTelescopeFiles/run-desy-11
find . -name '*.txt' -print | tar -cvzf run-desy-11.tar.gz --files-from -
mv run-desy-11.tar.gz /afs/cern.ch/work/q/qiwu/Allpix/rundata.r-20/RUN-DESY
