#!/bin/bash
top=${PWD} # must be the same folder as input macros
loc="/home/qiwu"
dir="/afs/cern.ch/work/q/qiwu/Data/Simulation_BD_SPS_r50"
idx=1000
...
while [ ${num} -le $2 ]; do
    ...
    cat > ./$fs0 << EOF
#!/bin/bash
# Batch job for run allpix simulation generated by ${PWD}/${me}.sh at $(date)
...
# do data analysis
ssh lxplus 'hostname; cd ${top}; ${top}/${fs2} &> ${top}/${fsh%.*}-remote.out'
...
# convert files
python /afs/cern.ch/work/q/qiwu/Allpix/allpix/share/TelescopeConverter.py ./${ftg} ./${flc} ${idx}
...
python ./RunFullChain.py -m DigitalCentroid -t reconstruction+analysis -o ${dir}/histo-clic -d ${dir}/histo-clic -a ${dir}/histo-clic -i ${num} -f ${num}
EOF
